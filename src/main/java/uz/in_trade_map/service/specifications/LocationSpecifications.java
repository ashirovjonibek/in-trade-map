...
public class LocationSpecifications {
    public static Specification<Location> findByRegionId(Integer regionId) {
        return (root, query, builder) -> regionId!=null?builder.equal(root.get("district").get("region").get("id"), regionId):query.getGroupRestriction();
    }

    public static Specification<Location> findByDistrictId(Integer districtId) {
        return (root, query, builder) -> districtId!=null?builder.equal(root.get("district").get("id"), districtId):query.getGroupRestriction();
    }
